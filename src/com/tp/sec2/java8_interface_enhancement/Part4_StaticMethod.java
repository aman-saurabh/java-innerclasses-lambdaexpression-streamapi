...
public class Part4_StaticMethod extends MyClass implements MyInterface {
	...
	public static void main(String[] args) {
		Part4_StaticMethod p = new Part4_StaticMethod();
		
		/*
		 * Accessing Parent class static methods
		 */
		Part4_StaticMethod.parentFirstStaticMethod();
		...
		Part4_StaticMethod.parentSecondStaticMethod();
		...
		Part4_StaticMethod.secondStaticMethod();
