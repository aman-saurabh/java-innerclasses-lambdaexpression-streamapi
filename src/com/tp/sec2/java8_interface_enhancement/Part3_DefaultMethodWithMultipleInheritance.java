...
public class Part3_DefaultMethodWithMultipleInheritance implements First, Second {
	...
	public static void main(String[] args) {
		Part3_DefaultMethodWithMultipleInheritance p = new Part3_DefaultMethodWithMultipleInheritance();
		p.m1();
		p.m2();
		p.m3();
	}
