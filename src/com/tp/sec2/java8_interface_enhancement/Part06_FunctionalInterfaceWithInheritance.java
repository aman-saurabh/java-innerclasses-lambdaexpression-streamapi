...
public class Part06_FunctionalInterfaceWithInheritance implements A, B {
	...
	public static void main(String[] args) {
		Part06_FunctionalInterfaceWithInheritance p = new Part06_FunctionalInterfaceWithInheritance();
		p.m1();
	}
}
